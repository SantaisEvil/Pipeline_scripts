...
in_dir = '/media/asangani1/NSD2_Project/2023-11-28/pre-analysis/'
file = 'macs/narrow/NA_peaks.narrowPeak'
ar_files = ['LNCaP_p300_WT','LNCaP_AR_WT','LNCaP_AR_Y1092A']
...
samples = ['LNCaP_AR_TM','LNCaP_AR_WT','LNCaP_AR_Y1092A']
print(samples)
a_samp = samples[0]
b_samp = samples[1]
c_samp = samples[2]
...
os.system('bedtools intersect -v -a '+ tmp_dir + a_samp+'_'+b_samp +' -b ' + tmp_dir + 'all' + ' > ' + tmp_dir + a_samp+'_'+b_samp)


os.system('bedtools intersect -wa -a '+ a+' -b '+c + ' > ' + tmp_dir + a_samp+'_'+c_samp)
os.system('bedtools intersect -v -a '+ tmp_dir + a_samp+'_'+c_samp +' -b ' + tmp_dir + 'all' + ' > ' + tmp_dir + a_samp+'_'+c_samp)

os.system('bedtools intersect -wa -a '+ b+' -b '+c + ' > ' + tmp_dir + b_samp+'_'+c_samp)
os.system('bedtools intersect -v -a '+ tmp_dir + b_samp+'_'+c_samp +' -b ' + tmp_dir + 'all' + ' > ' + tmp_dir + b_samp+'_'+c_samp)


os.system('bedtools intersect -v -a '+ a+' -b '+ tmp_dir + 'all ' + tmp_dir + a_samp+'_'+c_samp + ' ' +tmp_dir + a_samp+'_'+b_samp+ ' > ' + tmp_dir + a_samp)
os.system('bedtools intersect -v -a '+ b+' -b '+ tmp_dir + 'all ' + tmp_dir + b_samp+'_'+c_samp + ' ' +tmp_dir + a_samp+'_'+b_samp+' > ' + tmp_dir + b_samp)
os.system('bedtools intersect -v -a '+ c+' -b '+ tmp_dir + 'all ' + tmp_dir + a_samp+'_'+c_samp + ' ' +tmp_dir + b_samp+'_'+c_samp+  ' > ' + tmp_dir + c_samp)
